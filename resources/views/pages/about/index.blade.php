        ...
        <div class="max-w-5xl mx-auto">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div class="text-center">
                    <div class="text-4xl md:text-5xl font-bold text-primary-600 mb-2">{{ site_setting('stats.years', '10+') }}</div>
                    <div class="text-gray-600 font-medium">Años de Experiencia</div>
                </div>
                <div class="text-center">
                    <div class="text-4xl md:text-5xl font-bold text-primary-600 mb-2">{{ site_setting('stats.companies', '50+') }}</div>
                    <div class="text-gray-600 font-medium">Empresas Asesoradas</div>
                </div>
                <div class="text-center">
                    <div class="text-4xl md:text-5xl font-bold text-primary-600 mb-2">{{ site_setting('stats.projects', '100+') }}</div>
                    <div class="text-gray-600 font-medium">Proyectos Exitosos</div>
                </div>
                <div class="text-center">
                    <div class="text-4xl md:text-5xl font-bold text-primary-600 mb-2">{{ site_setting('stats.satisfaction', '95%') }}</div>
