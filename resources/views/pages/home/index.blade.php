    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-4xl mx-auto text-center text-white">
            ...
            <div class="flex justify-center">
                <a href="{{ route('contact') }}" class="btn bg-accent-600 hover:bg-accent-700 text-white text-lg px-10 py-4 shadow-xl hover:shadow-2xl transition-all">
                    <i class="fas fa-calendar-check mr-2"></i>{{ site_setting('hero.button_text', 'Agendar Consulta Gratis') }}
                </a>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16 max-w-3xl mx-auto">
                ...
                <div class="text-center">
                    <div class="text-4xl font-bold text-accent-400 mb-1">{{ site_setting('stats.companies', '50+') }}</div>
                    <div class="text-primary-200 text-sm">Empresas Asesoradas</div>
                </div>
                <div class="text-center">
                    <div class="text-4xl font-bold text-accent-400 mb-1">{{ site_setting('stats.projects', '100+') }}</div>
                    <div class="text-primary-200 text-sm">Proyectos Exitosos</div>
                </div>
                <div class="text-center">
                    <div class="text-4xl font-bold text-accent-400 mb-1">{{ site_setting('stats.satisfaction', '95%') }}</div>
...
<section class="py-20 bg-gray-50">
    <div class="container mx-auto px-4">
        <div class="text-center mb-16">
            <h2 class="section-heading">Servicios Principales</h2>
            <p class="section-subheading mx-auto">
                Soluciones integrales para mejorar la calidad y eficiencia de tu empresa
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <a href="{{ route('services.index') }}" class="group">
                <div class="service-card h-full transition-transform duration-300 group-hover:-translate-y-2">
                    ...
                    <h3 class="font-heading text-2xl font-bold text-gray-900 mb-3 group-hover:text-primary-700 transition-colors">
                        {{ $service->title }}
                    </h3>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <h2 class="font-heading text-4xl font-bold text-gray-900 mb-6">
                    Expertos en Calidad y Mejora Continua
                </h2>
                <p class="text-gray-600 text-lg mb-6 leading-relaxed">
                    Somos un equipo de consultores especializados con más de 10 años de experiencia transformando procesos industriales. Ayudamos a empresas en Colombia a alcanzar la excelencia operacional mediante la implementación de sistemas de gestión de calidad y metodologías de mejora continua.
                </p>
                ...
                <div class="space-y-4 mb-8">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Expertos en metodologías de mejora continua y reducción de variabilidad.</p>
                        </div>
                    </div>
                    <div class="flex items-start">
                        <i class="fas fa-check-circle text-success-600 text-2xl mr-3 mt-1"></i>
                        <div>
                            ...
                            <p class="text-gray-600">Certificaciones internacionales en sistemas de gestión de calidad.</p>
                        </div>
                    </div>
                    <div class="flex items-start">
                        <i class="fas fa-check-circle text-success-600 text-2xl mr-3 mt-1"></i>
            ...
            <div>
                <div class="relative">
                    <img src="{{ asset('images/consulting-team.png') }}" 
                         alt="Equipo de consultores MH Consultores" 
